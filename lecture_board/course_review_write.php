...
<div id="container" class="container">
    ...
    <div id="content" class="content">
        ...
        <form id="tx_editor_form" name="tx_editor_form" method="POST" action="/lecture_board/index.php?mode=regist">
        <table border="0" cellpadding="0" cellspacing="0" class="tbl-col">
            ...
            <tr>
                <th scope="col">제목</th>
                <td><input id="reviewTitle" name="reviewTitle" type="text" class="input-text" style="width:611px"/></td>
            </tr>
            <tr>
        ...
        <div class="editor-wrap">
            <!--<textarea name="editor" id="editor" rows="10" cols="105"></textarea>-->
            <?php
        ...
        <div class="box-btn t-r">
            ...
            <a href="#" class="btn-m ml5" onclick="registBtn();">저장</a>
        </div>
        </form>
...
<!--
$.ajax({
                url:"/lecture_board/lectureChk.php",
                type: "get",
                dataType: "json",
