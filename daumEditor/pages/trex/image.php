...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/daumEditor/css/uploadifive.css">

    <script src="https://code.jquery.com/jquery-1.12.4.min.js" type="text/javascript"></script>
    <script src="/daumEditor/js/jquery.uploadifive.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery("#file_upload").uploadify({
            ...
            , swf : "/module/uploadify.swf"            // 파일 업로드 이벤트에 사용될 플래쉬 파일
            , uploader : "/module/uploadifive.php"    // 파일 업로드를 수행할 php 파일
