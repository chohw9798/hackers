				...
				<div class="nav-box">
					...
					<ul class="nav-main-lst">
						...
						<li class="mnu5">
							<a href="#">직무교육 안내</a>
							<ul class="nav-sub-lst">
								<li><a href="/lecture_board/index.php?mode=list&tab=all&page=1">수강후기</a></li>
								<li><a href="#"> </a></li>
								<li><a href="#"> </a></li>
								<li><a href="#"> </a></li>
								<li><a href="#"> </a></li>
                    ...
                    <?php
                        ...
                        //로그인 후
                            ...
                            echo'
                               ...
                               <a href="/member/index.php?mode=modify">내 정보 수정</a>
                            ';
                            if($_SESSION['isAdmin']==1){
                                echo'<a href="/admin/index.php?mode=list">강의 Admin</a>';
                            }
                        }
                    ?>
